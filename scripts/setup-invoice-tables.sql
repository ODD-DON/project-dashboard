...
CREATE POLICY IF NOT EXISTS "Allow all operations on invoice_projects" ON invoice_projects
  FOR ALL USING (true);

CREATE POLICY IF NOT EXISTS "Allow all operations on exported_invoices" ON exported_invoices
  FOR ALL USING (true);
