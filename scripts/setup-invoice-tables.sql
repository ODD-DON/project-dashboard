-- Create the invoice_projects table for projects ready to be invoiced
...
-- Create the exported_invoices table for invoice history
...
-- Create the invoice_numbers table to track next invoice number per brand
