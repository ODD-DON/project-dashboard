    ...
    <Card ref={setNodeRef} style={style} className="mb-4 touch-manipulation">
      <CardContent className="p-4">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <button
              ...
              className="font-semibold text-lg truncate text-left hover:text-blue-600 transition-colors"
            >
              {project.title}
            </button>
          </div>
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => onProjectClick(project)}
            className="text-sm text-gray-600 line-clamp-2 text-left hover:text-gray-800 transition-colors"
          >
            {project.description}
          </button>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-xl md:text-2xl font-bold text-gray-900">Project Dashboard</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="flex items-center gap-2 text-gray-700 text-base md:text-lg">
          ...
          {selectedProject && (
            <>
              <DialogHeader>
                ...
                <DialogDescription className="text-base">Project details and specifications</DialogDescription>
              </DialogHeader>
